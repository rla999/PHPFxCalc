...
<html>
    ...
    <body>
        ...
        <br/>
        <main>
            <form name="<?php echo $fxDataModel::FORM_NAME_TITLE ?>" action="<?php echo $fxDataModel::FORM_NAME ?>" method="post">
                ...
                <input type="text" name="<?php echo $iniArray[$fxDataModel::SOURCE_AMOUNT_KEY]; ?>" value="<?php
                ...
                <input type="text" readonly name="<?php echo $iniArray[$fxDataModel::DEST_AMOUNT_KEY]; ?>" id="outputText" class="textField" value="<?php
                if (isset($_POST[$fxDataModel::CONVERT_BUTTON])) {
                    echo $destAmount;
                }
                ?>"/>
                ...
                <input type="submit" name="<?php echo $fxDataModel::CONVERT_BUTTON ?>" value="CALCULATE" class="button"/>
                <input type="reset" name="<?php echo $fxDataModel::RESET_BUTTON ?>" value="RESET" onclick="window.location.href = 'fxCalc.php'" class="button"/>
